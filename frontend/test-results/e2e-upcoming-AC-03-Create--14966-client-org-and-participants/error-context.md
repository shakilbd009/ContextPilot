...
- Name: e2e/upcoming.spec.ts >> AC-03: Create meeting with description, client/org, and participants
- Location: tests/e2e/upcoming.spec.ts:105:1
...
Locator: getByText('Acme Quarterly Sync')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Acme Quarterly Sync')
...
- banner:
  ...
  - link "Sign in":
    - /url: /login
- main:
  - heading "Schedule Meeting" [level=1]
  - paragraph: Create a future meeting record for pre-call preparation
  - alert: An unexpected error occurred. Please try again.
  - text: Meeting title
  - textbox "Meeting title":
    - /placeholder: Q3 Planning Review
    - text: Acme Quarterly Sync
  - text: Date
  - textbox "Date":
    - /placeholder: ""
    - text: 2026-06-04
  ...
  - textbox "Time":
    - /placeholder: ""
    - text: 11:00
  - text: Description / agenda (optional)
  - textbox "Description / agenda (optional)":
    - /placeholder: What will this meeting cover?
    - text: Review Q3 results and Q4 targets.
  - text: Client or organization
  - textbox "Client or organization":
    - /placeholder: Acme Corp
    - text: Acme Corp
  - group "Participants (optional)":
    - text: Participants (optional)
    - paragraph: Add participants to improve briefing accuracy.
    - text: Display name
    - textbox "Display name":
      - /placeholder: Alice Smith
      - text: Alice Smith
    - button "Remove participant 1"
    - textbox "Alice Smith"
    - button "Remove participant 2"
    - button "Add participant"
    - button "Show email and organization"
  - button "Cancel"
